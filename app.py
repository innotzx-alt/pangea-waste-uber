...
def api_sajili_dereva():
    ...
    madereva = pakia_data(FAILI_LA_MADEREVA, [
        {"jina": "Kassim wa Guta", "simu": "0711223344", "aina_gari": "Guta/Mkokoteni", "uwezo_tani": 1.5},
...
@app.route('/omba_gari', methods=['POST'])
def api_omba_gari():
    data = request.get_json()
    mteja = data.get("mteja", "Mteja we kwanza")
    mtaa = data.get("mtaa")
    ...
    # Mfumo unatoa TSh 5,000 kwa kila tani ya taka iliyobeba
